...
const Home = () => {
    ...
    return (
        <div className="pt-14 container">
            ...
            “A vosotros que habéis despertado mi ira, ahora enfrentaréis mi desafío. Preparaos para cuestionar vuestras creencia, el destino pende de la sagacidad de vuestras respuestas."
            ...
            “Vida les ha otorgado muchos presentes; yo, les daré uno de mis dones más preciados. Un regalo de la Muerte no se rechaza, así que espero ver la misma alegría con la que festejáis la Vida. A partir de este momento serán capaces de ver el tiempo restante de todos sus seres más queridos; pero, cada vez que vean esos números sobre la cabeza de vuestra esposa, madre o hijo, estos comenzarán a descender cada vez más. Aunque apartéis la mirada, la curiosidad de vuestros ojos siempre regresarán a esos infames números rojos, una y otra vez...”
            ...
            No pueden autolesionarse ni dañar su propia salud física o mental como medio para cumplir la renuncia.
            No pueden simplemente trasladar la práctica a otro miembro de la sociedad o familia, la renuncia debe ser completa y comunal.
            No pueden argumentar que la muerte o el sacrificio de otro ser humano es válido para evitar la renuncia.
            No pueden abandonar sus comunidades o familias para evitar formar nuevos lazos afectivos.
            No pueden recurrir a la negación o rechazo de su cultura para facilitar la renuncia.
            No pueden sustituir las prácticas renunciadas por otras que les proporcionen beneficios similares.
        </div>
    );
}
